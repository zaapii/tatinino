...
export function useMapLayers() {
  const layers = ref<MapLayerDefinition[]>([
    ...
    },
    {
      ...
      source: { file: 'reservorios.geojson', dataUrl: '/data/hydraulics/reservorios.geojson', featureCount: 31, color: '#237b9d', minZoom: 10.5, lineWidth: 2.2, fillOpacity: 0.4 },
    },
    {
      ...
      source: { file: 'canales.geojson', dataUrl: '/data/hydraulics/canales.geojson', featureCount: 90, color: '#168d8c', minZoom: 10.5, lineWidth: 4.2 },
    },
    {
      ...
      source: { file: 'barrios_renabap.geojson', dataUrl: '/data/territory/barrios_renabap.geojson', featureCount: 69, color: '#b64f7a', minZoom: 9.5, lineWidth: 1.7, fillOpacity: 0.5, labelProperty: 'barrio', labelMinZoom: 11.5 },
    },
    {
      ...
      source: { file: 'estaciones_bombeo.geojson', dataUrl: '/data/hydraulics/estaciones_bombeo.geojson', featureCount: 51, color: '#d59a27', minZoom: 11.5, lineWidth: 1.5, pointRadius: 5.5, fillOpacity: 0.26 },
    },
    {
